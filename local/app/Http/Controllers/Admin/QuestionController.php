...
class QuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'คำคามที่พบบ่อย';
        $data['title_page'] = 'คำคามที่พบบ่อย';
    ...
    public function Lists(){
        ...
        ->addColumn('action',function($rec){
            $str='
                <a href="'.url('admin/Question/Answer/'.$rec->id).'"  class="btn btn-simple btn-success btn-icon plus  btn-tooltip" data-rel="tooltip" data-id="'.$rec->id.'" title="คำตอบ">
                    <i class="ti-plus"></i>
                </a>
