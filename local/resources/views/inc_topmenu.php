<link rel="stylesheet" href="side-shopping-cart/css/style.css">
<script src="side-shopping-cart/js/modernizr.js"></script>
<script src="side-shopping-cart/js/main.js"></script>
<script src="side-shopping-cart/js/jquery.mobile.custom.min.js"></script>
			...
			<div class="col">
				<div class="sideright_top">
					...
					<li><div class="langselect d-block d-sm-block d-md-block d-lg-none d-xl-none">
								...
								<a href="#"><img src="images/th.png"></a>
...
<div class="d-block d-sm-block d-md-block d-lg-none d-xl-none">
	...
	<nav id="main-nav">
		<div class="menu-m padd">
			<ul class="menumobile">
				<li>
					<div class="mmmbg-0"><a href="index.php"> Home</a></div>
				</li>
<!--
