				...
				<div class="col">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">กองทุนส่วนบุคคล</li>
						</ol>
					</nav>
				</div>
			</div>
				...
				<div class="row">
					<div class="col">
						<div class="detail_private">
							<h2>กองทุนส่วนบุคคลคืออะไร</h2>
							<p><span class="orangetxt">กองทุนส่วนบุคคล </span>คือ กองทุนที่บุคคล คณะบุคคล หรือนิติบุคคลใดๆ ที่มีวัตถุประสงค์ต้องการลงทุนในหลักทรัพย์ประเภทต่างๆ
								<br> ทำการมอบหมายให้บริษัทจัดการหรือสถาบันการเงินที่ได้รับอนุญาตจัดการกองทุนส่วนบุคคลเป็นผู้บริหารเงินลงทุน
								<br> โดยมีการทำความเข้าใจร่วมกันระหว่างบริษัทจัดการและผู้ลงทุนถึงนโยบายการลงทุน เป้าหมายทางการเงิน ความต้องการผลตอบแทนและระยะเวลาการลงทุน
								<br> โดยจัดทำเป็นหนังสือสัญญาข้อตกลงระหว่างบริษัทจัดการกับผู้ลงทุน </p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col">
						<div class="detail_private">
							...
							<h2 class="mt-5">โครงสร้างของกองทุนส่วนบุคคล</h2>
				...
				<div class="row">
					...
					<table class="table funds_table_perf table-bordered table-responsive-lg">
									<thead>
										...
										<tr>
											<th scope="col">นโยบายการลงทุน</th>
											<th scope="col">สัดส่วนการลงทุนใน
ตราสารหนี้และตราสารอื่นที่มี
ลักษณะคล้ายตราสารหนี้</th>
											<th scope="col">สัดส่วนการลงทุนใน
ตราสารทุนและตราสารอื่น
ที่มีลักษณะคล้ายตราสารทุน</th>
											<th scope="col">ผลตอบแทนคาดหวัง</th>
										
										</tr>
									</thead>
									<tbody>
										<tr>
											<th scope="row">คาดหวังผลตอบแทนน้อย 
ความเสี่ยงต่ำ (Conservative)</th>
											<td>80-100%</td>
											<td>0-20% </td>
											<td>สูงกว่าดอกเบี้ยเงินฝาก </td>
											
										</tr>
										<tr>
											<th scope="row">คาดหวังผลตอบแทนปานกลาง
ความเสี่ยงปานกลาง (Moderate)</th>
											<td>40-60% </td>
											<td>40-60% </td>
											<td>สูงกว่านโยบายการลงทุนแบบ
Conservative </td>
											
										</tr>
										<tr>
											<th scope="row">คาดหวังผลตอบแทนสูง
ความเสี่ยงสูง (Aggressive)</th>
											<td>0-20% </td>
											<td>80-100% </td>
											<td>สูงกว่านโยบายการลงทุนแบบ
Aggressive </td>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="benefit_info">
							<h3> คาดหวังผลตอบแทนปานกลาง
 <br> <span class="bluetxt lighttxt">ความเสี่ยงปานกลาง (Moderate)</span></h3>
				...
				<div class="row">
					<div class="col">
						<div class="color_each">
							<img src="images/private_funds_19.png"> ตราสารหนี้ และตราสารที่มีลักษณะคล้ายตราสารหนี้
						</div>
					</div>
					<div class="col">
						<div class="color_each">
							<img src="images/private_funds_22.png">ตราสารทุน และตราสารที่มีลักษณะคล้ายตราสารทุน
						</div>
					</div>
				</div>
				<div class="row mt-5">
...
- ลดภาระการติดต่อสถาบันการเงิน การติดตามข่าวสาร และ การบริหารเงินด้วยตนเอง</p> <br>
				...
				<h2>ติดต่อ-สอบถาม</h2>
				<p>ฝ่ายการตลาดกองทุนส่วนบุคคล บริษัทหลักทรัพย์จัดการกองทุน โซลาริส จำกัด  <br>
 โทร 02 – 624 – 6305 และ 02 – 624 – 6313</p>
				<br><br>
