            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="content">
                        ...
                        @foreach ($fund_info as $K_fund_info => $V_fund_info)
                                    @switch($V_fund_info->sort_id)
                                        @case(1)
                                            <div class="content">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="pill1" aria-expanded="true">
                                                        {!!($V_fund_info->detail_th)!!}
                                                        <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                แก้ไขข้อมูล
                                                        </button> 
                                                    </div>
                                                    <div class="tab-pane" id="pill2" aria-expanded="false">
                                                        {!!($V_fund_info->detail_en)!!}
                                                        <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                แก้ไขข้อมูล
                                                        </button> 
                                                    </div>
                                            ...
                                            <div class="content">
                                                <div class="nav-tabs-navigation">
                                                    <div class="nav-tabs-wrapper">
                                                        <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                                            <li class="nav-item">
                                                                <a href="#pill11" class="nav-link active" data-toggle="tab" aria-expanded="true">ไทย</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="#pill12" class="nav-link" data-toggle="tab" aria-expanded="false">อังกฤษ</a>
                                                            </li>                                            
                                                        </ul>
                                                    </div>                                   
                                                </div> 
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="pill11" aria-expanded="true">
                                                        {!!($V_fund_info->detail_th)!!}
                                                        <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                แก้ไขข้อมูล
                                                        </button> 
                                                    </div>
                                                    <div class="tab-pane" id="pill12" aria-expanded="false">
                                                        {!!($V_fund_info->detail_en)!!}
                                                        <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                แก้ไขข้อมูล
                                                        </button> 
                                            ...
                                            <div class="content">
                                                <div class="nav-tabs-navigation">
                                                    <div class="nav-tabs-wrapper">
                                                        <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                                            <li class="nav-item">
                                                                <a href="#pill13" class="nav-link active" data-toggle="tab" aria-expanded="true">ไทย</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="#pill14" class="nav-link" data-toggle="tab" aria-expanded="false">อังกฤษ</a>
                                                            </li>                                            
                                                        </ul>
                                                    </div>                                   
                                                </div> 
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="pill13" aria-expanded="true">
                                                            {!!($V_fund_info->detail_th)!!}
                                                            <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                    แก้ไขข้อมูล
                                                            </button> 
                                                        </div>
                                                        <div class="tab-pane" id="pill14" aria-expanded="false">
                                                            {!!($V_fund_info->detail_en)!!}
                                                            <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                    แก้ไขข้อมูล
                                                            </button> 
                                                ...
                                                <div class="content">
                                                    <div class="nav-tabs-navigation">
                                                        <div class="nav-tabs-wrapper">
                                                            <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                                                <li class="nav-item">
                                                                    <a href="#pill15" class="nav-link active" data-toggle="tab" aria-expanded="true">ไทย</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="#pill16" class="nav-link" data-toggle="tab" aria-expanded="false">อังกฤษ</a>
                                                                </li>                                            
                                                            </ul>
                                                        </div>                                   
                                                    </div> 
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="pill15" aria-expanded="true">
                                                            {!!($V_fund_info->detail_th)!!}
                                                            <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                    แก้ไขข้อมูล
                                                            </button> 
                                                        </div>
                                                        <div class="tab-pane" id="pill16" aria-expanded="false">
                                                            {!!($V_fund_info->detail_en)!!}
                                                            <button class="btn btn-danger btn-edit pull-right" data-id="{{$V_fund_info->id}}">
                                                                    แก้ไขข้อมูล
                                                            </button> 
