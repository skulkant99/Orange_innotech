        ...
        <div class="modal-content">
            <form id="FormAdd">
                ...
                <div class="form-group">
                    <label for="add_question_th">คำถาม(TH)</label>
                    <textarea id="add_question_th" name="question_th" class="form-control"></textarea>
                </div>

                <div class="form-group">
                        <label for="add_question_en">คำถาม(EN)</label>
                        <textarea id="add_question_en" name="question_en" class="form-control"></textarea>
                </div>
    ...
    <div class="modal-dialog" role="document" style="max-width:70%;max-height:70%;">
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                <div class="form-group">
                    <label for="edit_question_th">คำถาม(TH)</label>
                    <textarea id="edit_question_th" name="question_th" class="form-control"></textarea>
                </div>

                <div class="form-group">
                        <label for="edit_question_en">คำถาม(EN)</label>
                        <textarea id="edit_question_en" name="question_en" class="form-control"></textarea>
                </div>
...
<script>
    ...
    $('body').on('click','.btn-edit',function(data){
        ...
        $.ajax({
            ...
            CKEDITOR.instances['edit_question_th'].setData(rec.question_th);
            CKEDITOR.instances['edit_question_en'].setData(rec.question_en);
    ...
    CKEDITOR.replace('add_question_th');
    CKEDITOR.replace('edit_question_th');
    CKEDITOR.replace('add_question_en');
    CKEDITOR.replace('edit_question_en');
