        ...
        <div class="modal-content">
            <form id="FormAdd">
                ...
                <div class="form-group">
                    <label for="add_answer_th">คำตอบ(TH)</label>
                    <textarea id="add_answer_th" name="answer_th" class="form-control"></textarea>
                </div>

                <div class="form-group">
                    <label for="add_answer_en">คำตอบ(EN)</label>
                    <textarea id="add_answer_en" name="answer_en" class="form-control"></textarea>
                </div>
    ...
    <div class="modal-dialog" role="document" style="max-width:70%;max-height:70%;">
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                <div class="form-group">
                    <label for="edit_answer_th">คำตอบ(TH)</label>
                    <textarea id="edit_answer_th" name="answer_th" class="form-control"></textarea>
                </div>

                <div class="form-group">
                    <label for="edit_answer_en">คำตอบ(EN)</label>
                    <textarea id="edit_answer_en" name="answer_en" class="form-control"></textarea>
                </div>
...
<script>
    ...
    $('body').on('click','.btn-edit',function(data){
        ...
        $.ajax({
            ...
            CKEDITOR.instances['edit_answer_th'].setData(rec.answer_th);
            CKEDITOR.instances['edit_answer_en'].setData(rec.answer_en);
    ...
    CKEDITOR.replace('add_answer_th');
    CKEDITOR.replace('edit_answer_th');
    CKEDITOR.replace('add_answer_en');
    CKEDITOR.replace('edit_answer_en');
