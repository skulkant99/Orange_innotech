    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="FormAdd">
                ...
                <div class="form-group">
                    <label for="add_name_en">ชื่อ(อังฤษ)</label>
                    <input type="text" class="form-control" name="name_en" id="add_name_en"  placeholder="ชื่อ(อังฤษ)">
                </div>

                <div class="form-group">
                    <label for="add_fund_short_name">ชื่อย่อ</label>
                    <input type="text" class="form-control" name="fund_short_name" id="add_fund_short_name"  placeholder="ชื่อย่อ">
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                <div class="form-group">
                    <label for="edit_name_en">ชื่อ(อังฤษ)</label>
                    <input type="text" class="form-control" name="name_en" id="edit_name_en"  placeholder="ชื่อ(อังฤษ)">
                </div>

                <div class="form-group">
                    <label for="edit_fund_short_name">ชื่อย่อ</label>
                    <input type="text" class="form-control" name="fund_short_name" id="edit_fund_short_name"  placeholder="ชื่อย่อ">
                </div>
...
<script>
     ...
     var TableList = $('#TableList').dataTable({
        "ajax": {
            "url": url_gb+"/admin/FundPerformance/Lists",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('body').on('click','.btn-delete',function(e){
        ...
        swal({
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/Fund/Delete/"+id,
                data : {ID : id}
            }).done(function(rec){
                if(rec.status==1){
                    swal(rec.title,rec.content,"success");
