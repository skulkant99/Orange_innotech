        ...
        <div class="modal-content">
            <form id="FormAdd">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="year_no" id="add_year_no" required="" placeholder="year_no">
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="year_no" id="edit_year_no" required="" placeholder="year_no">
                </div>
...
<script>
    ...
    $('body').on('click','.btn-delete',function(e){
        ...
        swal({
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/Year/Delete/"+id,
                data : {ID : id}
            }).done(function(rec){
                if(rec.status==1){
                    swal(rec.title,rec.content,"success");
