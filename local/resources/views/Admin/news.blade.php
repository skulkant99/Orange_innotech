    ...
    <div class="modal-dialog" role="document" style="max-width:70%;max-height:70%;">
        <div class="modal-content">
            <form id="FormAdd">
                ...
                <div class="form-group">
                    <label for="add_title_th">หัวเรื่อง(TH)</label>
                    <input class="form-control" name="title_th" id="add_title_th" required="" placeholder="title_th">
                </div>
        
                <div class="form-group">
                    <label for="add_title_en">หัวเรื่อง(EN)</label>
                    <input id="add_title_en" name="title_en" class="form-control"  placeholder="title_en">
                </div>
    ...
    <div class="modal-dialog" role="document" style="max-width:70%;max-height:70%;">
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                <div class="form-group">
                    <label for="edit_title_th">หัวเรื่อง(TH)</label>
                    <input class="form-control" name="title_th" id="edit_title_th" required="" placeholder="title_th">
                </div>
        
                <div class="form-group">
                    <label for="edit_title_en">หัวเรื่อง(EN)</label>
                    <input id="edit_title_en" name="title_en" class="form-control" placeholder="title_en">
                </div>
