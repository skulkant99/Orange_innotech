										...
										<div class="row">
											<div class="col">
												<div class="bannertxt_top">
													<h1>กองทุนเปิดโซลาริสตราสารทุนเพื่อการเลี้ยงชีพ
													<br><span class="boldtext"> SOLARIS EQUITY RMF (S-EQRMF)</span></h1> </div>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="container">
				<div class="row mt-5">
					<div class="col  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
						...
						<div class="righttext">
							<div class="title_head1"> กองทุนเปิดโซลาริสตราสารทุนเพื่อการเลี้ยงชีพ
								<br> <span class="bluetxt">SOLARIS EQUITY RMF (S-EQRMF)</span> </div>
						</div>
					</div>
				</div>
				<br>
				...
				<div class="row">
					<div class="col">
						<div class="detail_content">
							...
							<br>
							<h2>วัตถุประสงค์</h2>
							<li><i class="far fa-arrow-alt-circle-right"></i> เพื่อส่งเสริมการออมระยะยาวเพื่อการเลี้ยงชีพของผู้ถือหน่วยลงทุน </li>
							<li><i class="far fa-arrow-alt-circle-right"></i>  เพื่อสร้างผลตอบแทนในระยะยาวให้แก่ผู้ถือหน่วยลงทุน โดยการลงทุนในตราสารแห่งทุน หลักทรัพย์หรือตราสารทางการเงินอื่นที่มีความมั่นคง ภายใต้การบริหารการลงทุน โดยผู้มีความรู้และประสบการณ์ ตลอดจนให้ความรู้ในการลงทุนแบบต่อเนื่อง ระยะยาวเพื่อการใช้จ่ายหลังเกษียณหรือเมื่อเลิกทำงาน</li>
							<br>
							<br>
												...
												<tr class="setheigh">
													...
													<td>
														...
														<div class="row">
															...
															<div class="col"> ไม่เกินร้อยละ 1.00 ของมูลค่าทรัพย์สินสุทธิต่อปี </div>
														</div>
