							...
							<div class="col">
								<div class="flexslider-caption">
									...
									foreach ($banner as $_banner) {?>
										<li> <?php echo '<img src="'.asset('uploads/Banner/'.$_banner->photo).'" class="img-fluid d-none d-sm-none d-md-none d-lg-block d-xl-block">'; ?>
				...
				<div class="row mt-3 mb-5">
					<div class="col  wow fadeInDown" data-wow-duration="1.3s" data-wow-delay="0.1s">
						<div class="inno_update owl-carousel owl-theme">
							<?php foreach ($information as $_information) {
										...
										<div class="box_nav">
											<div class="pic_nav">
												<div class="hov-menu-sty2">
													<figure>
														<a href="#"><img src="'.asset('uploads/Information/'.$_information->photo).'" class="img-fluid"> </a>
													</figure>
												</div>
											</div>
											<div class="inno_details"> '.$_information->detail.' </div> <a href="#" class="readmore">เพิ่มเติม</a> </div>
									</div>';
								}
							} ?>
